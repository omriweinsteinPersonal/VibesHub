...
9. Deliver normalized discounts, controlled video, analytics, and native feature parity in phased releases. **Normalized discount codes, recommendation ordering, recoverable archiving, creator profile settings, first-party creator analytics, and the in-app story viewer are complete; controlled video upload and native parity remain.**
