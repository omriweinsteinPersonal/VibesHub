...
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Link unavailable | swavii</title></head>
<body><main><h1>This shopping link is unavailable</h1><p>Please return to swavii and try another recommendation.</p></main></body></html>`;
